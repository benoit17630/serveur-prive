...
WEEKLY_EXCHANGE_LIMIT = 1000000 -- Maximum amount of sparks that can be spent per week (default retail value: 100000)
...
ADVANCED_JOB_LEVEL = 10 -- Minimum level to accept advanced job quests.  Set to 0 to start the game with advanced jobs.
...
SPARKS_RATE     = 3.000 -- Multiplies sparks earned from records of eminence.
...
-- DYNAMIS SETTINGS
BETWEEN_2DYNA_WAIT_TIME  = 2       -- Hours before player can re-enter Dynamis. Default is 1 Earthday (24 hours).
...
RELIC_2ND_UPGRADE_WAIT_TIME = 60  -- Wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 7200s = 2 hours.
RELIC_3RD_UPGRADE_WAIT_TIME = 60  -- Wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 3600s = 1 hour.
...
AQUAVEIL_COUNTER = 10  -- Base amount of hits Aquaveil absorbs to prevent spell interrupts. Retail is 1.
